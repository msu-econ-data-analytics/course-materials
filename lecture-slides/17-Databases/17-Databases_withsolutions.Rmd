---
title: "Lecture 17: Databases and Big Data"
author: "Nick Hagerty <br> ECNS 491/560 Fall 2022 <br> Montana State University"
date: "<br> *Based partly on materials by [Grant McDermott](https://raw.githack.com/uo-ec510-2020-spring/lectures/master/15-databases/15-databases.html) under an MIT license."
output:
...
* Combines the best features of cluster computing and relational databases.
...
Basically all databases use **SQL** (Structured Query Language). SQL is:
...
**What does `# Source: lazy query` mean?**
...
5. **Advanced:** What percentage of flights took off in freezing temperatures? Make sure to confirm the join gives you what you want. *(Hint: First just count the number of flights that took off in temperatures below and above freezing -- calculating the percentage within SQL requires a subquery.)*
