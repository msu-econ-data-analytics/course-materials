---
title: "Week 9: Exploratory Analysis, Part 2"
...
- New this year! Correctly handles many of the finer statistical details.
...
This section is drawn from material by [Ed Rubin](https://github.com/edrubin/EC607S21/tree/master/notes-lecture/03-why-regression) (with permission).

---

# The Conditional Expectation Function (CEF)

The CEF tells us the **expected value** (population mean) of an outcome variable $Y_i$ for each value of $X_i$.
$$ \mathbb{E}[Y_i|X_i] $$
...
```
Source: [Wikipedia](https://commons.wikimedia.org/wiki/File:Simpsons_paradox_-_animation.gif)
...
```
Source: [RJ Andrews @infowetrust](https://twitter.com/infowetrust/status/984536880199876608)
...
```
Source: [Nick Huntington-Klein](https://nickchk.com/causalgraphs.html)
...
This section is drawn from Rafael Irizarry, [*Introduction to Data Science*](https://rafalab.github.io/dsbook/), chapter 28.
...
```
Source: <a href="https://en.wikipedia.org/wiki/Kernel_(statistics)">Wikipedia</a>
...
# Beware of default smoothing methods and parameters
