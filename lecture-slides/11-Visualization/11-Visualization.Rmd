...
date: "<br> *Based on materials by [Rafael Irizarry](https://rafalab.github.io/dsbook/introduction-to-data-visualization.html) (under a CC license) and [Ed Rubin](https://raw.githack.com/edrubin/EC525S19/master/NotesLab/05RPlot/05RPlot.html) (with permission)"
output:
...
Counts every country the same within each continent; every continent has the same area:
...
If you use a pie chart, at least label the segments and values.
...
```
Source: [New York Times, March 20, 2020](https://www.nytimes.com/2020/03/20/health/coronavirus-data-logarithm-chart.html)
...
Source: Jonathan Schwabish (2014), ["An Economist's Guide to Visualizing Data,"](https://www.aeaweb.org/articles?id=10.1257/jep.28.1.209) *Journal of Economic Perspectives*.
