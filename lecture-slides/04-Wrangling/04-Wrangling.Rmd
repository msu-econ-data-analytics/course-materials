---
title: "Lecture 4: Data Wrangling in the Tidyverse"
author: "Nick Hagerty* <br> ECNS 491/560 Fall 2022 <br> Montana State University"
date: ".small[<br> *Parts of these slides are adapted from [“Data Science for Economists”](https://raw.githack.com/uo-ec607/lectures/master/05-tidyverse/05-tidyverse.html) by Grant R. McDermott, used under the [MIT License](https://github.com/uo-ec607/lectures/blob/master/LICENSE). Images are from [ModernDive](https://moderndive.com/3-wrangling.html) by Chester Ismay and Albert Y. Kim, used under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/).]"
output:
...
.smaller[Image is from ["R for Data Science"](https://r4ds.had.co.nz/relational-data.html) by Hadley Wickham & Garrett Grolemund, used under [CC BY-NC-ND 3.0](https://creativecommons.org/licenses/by-nc-nd/3.0/us/) and is not included under this resource's overall CC license.]
