...
* This is an example of a **full path.** It starts with `C:/` on Windows or `/` on Mac.
...
In R you can use either a full or relative path in any given situation, but relative paths are usually easier to work with.
