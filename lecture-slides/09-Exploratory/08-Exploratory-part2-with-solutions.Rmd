...
```{r, fig.height = 3.25, message = FALSE, warning = FALSE, out.width = "80%"}
london3 = london2 |>
...
- For **causal inference:** if the variation in $X$ is as-good-as-random, then the CEF shows how $X$ causally affects $Y$.
...
- Why not always show binscatter or local regression plots?
