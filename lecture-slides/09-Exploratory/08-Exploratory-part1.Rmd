...
"Don't we need the data to be normal to run a regression?"
- No! This is a common misconception that still gets taught in statistics classes.
- OLS does not assume or require that your variables follow a normal distribution.
- As long as you use robust standard errors (which you should anyway).
