---
title: "Lecture 8: <br> Distinguishing Goals of Data Analysis"
...
- $Y^0_i =$ outcome for person $i$ if $T_i = 1$ (take Advil).
- $Y^1_i =$ outcome for person $i$ if $T_i = 0$ (don't take Advil).
...
Y_i
&= f(T_i, x_{1i}, ..., x_{Ni}) \\
&= \beta_0 T_{i} + \beta_1 x_{1i} + \beta_2 x_{2i} + ... + \varepsilon_i
\end{aligned}$$
...
$$\color{#6A5ACD}{Y_i} = f(T_i, x_{1i}, ..., x_{Ni}) = \color{#e64173}{\beta_0} T_{i} + \beta_1 x_{1i} + \beta_2 x_{2i} + ... + \varepsilon_i$$
